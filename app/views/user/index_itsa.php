...
<div class="panel-group panel-accordion" id="accordion_itsa" role="tablist">
	<div class="panel panel-success">
		<div class="panel-heading" role="tab">
			<h4 class="panel-title">
				<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_itsa" href="#itsa">
					ITSA 競賽紀錄
				</a>
			</h4>
		</div>
		<div id="itsa" class="panel-collapse collapse" role="tabpanel">
			<div class="panel-body">
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php foreach ($history_itsa as $key => $team) {?>
						<tr>
							<td>
